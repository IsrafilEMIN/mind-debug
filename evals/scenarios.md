...
Status: **not executed in Hermes or OMP**. These are evaluation specifications, not passing test results. Structural unit tests cannot demonstrate prioritization quality.
